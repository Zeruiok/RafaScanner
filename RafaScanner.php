        ...
        if ($opcaoscanner == "0") {
            ...
            echo $bold . $amarelo . "[•] Checando se o replay foi passado...\n";
                ...
                if ($encontrouBypassPasta || $encontrouReplayPassadoPasta) {
                    echo $bold . $vermelho . "[!] Modificação suspeita detectada na pasta shaders! Aplique w.o\n";
                        ...
                        if ($resultadoDataModifyArquivo !== '' && $resultadoDataChangeArquivo !== '') {
                            try {
                                ...
                                if ($dataModifyArquivo != $dataChangeArquivo) {
                                    echo $bold . $vermelho . "[!] Modificação detectada no arquivo: $nomeArquivo! Aplique w.o\n\n";
            ...
            echo $bold . $azul . "[•] Checando se o replay foi passado...\n";
                ...
                echo "\n" . $bold . $amarelo . "[*] Data da alteração na pasta 'gameassetbundles': " . ($dataChangeFormatada ?: "Não encontrada") . "\n";
                echo $bold . $branco . "[*] Verifique o horário da  alteração, se for após a partida, aplique w.o\n\n";
                ...
                echo $bold . $vermelho . "[!] Após verificar no jogo  se o acusado está de Holograma verifique os horários do Shaders e OBB e compare caso esteja muito diferente as datas, aplique w.o\n\n";
